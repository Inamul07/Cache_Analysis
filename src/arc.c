...
double arc_get_hashmap_time(arc_cache* cache) {
    ...
    double totalTime = 0;
    totalTime += hmap_get_time_taken(cache->t1Map);
    totalTime += hmap_get_time_taken(cache->t2Map);
    totalTime += hmap_get_time_taken(cache->b1Map);
    totalTime += hmap_get_time_taken(cache->b2Map);
    return totalTime;
}