...
final: main.o lru.o clock.o two_queue.o
	gcc -o main main.o lru.o clock.o two_queue.o -L./lib/ -ldbllist -lhashmap -Wl,-rpath,./lib/
	./main
...
clean: 
	rm -f main.o lru.o clock.o two_queue.o main
